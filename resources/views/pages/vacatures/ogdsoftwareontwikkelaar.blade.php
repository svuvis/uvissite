			...
			<div class="container">
				<div class="row centered">
					<div class="col-lg-8 col-lg-offset-2">
						<h1 class="h9" style="color: #fff;">BIJBAAN SOFTWARE-ONTWIKKELAAR</h1>
        	...
        	<div class="container">
        	    <div class="row centered">
                    ...
                    <div class="col-lg-6">
        				...
        				<p style="text-align: left;">
                            OGD is altijd op zoek naar studenten die een bijbaan willen in de ict. Wil jij werkervaring opdoen als software-ontwikkelaar terwijl je nog aan het studeren bent? Bij ons kan het. Veel voorkomende talen op onze projecten zijn Java, PHP en de verschillende .NET-varianten. Maar ook andere talen komen voor.
                        </p>
                        <p style="text-align: left;">
                            Niet alleen kun je bij ons relevante werkervaring opdoen, je kan ook je kennis uitbreiden met onze vele gratis cursussen. Van beginnerscursussen voor PHP, Java of Ruby tot trainingen voor gevorderden op het gebied van design patterns.
                        </p>
                        <p style="text-align: left;">
                            We bieden je…<br />
                        ...
                        <p style="text-align: left;">
                            Vakgebieden: softwareontwikkeling, PHP, Java, .NET<br />
